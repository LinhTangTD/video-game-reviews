...
write_csv(games, "clean_data_meta.csv") # dim: 18295 x 197
...
write_csv(games, "clean_data_eda.csv") # dim: 18295 x 191
...
write_csv(games, "clean_data_model.csv") # dim: 17657 x 191
```
